...
let Field = function(obj){
    ...
    this.isOpen = false
    this.isFlag = false
    this.dom.style.backgroundColor = '#C9CABB'
    ...
    this.dom.onmouseover = () => {
        if(!this.isOpen)this.dom.style.backgroundColor = '#EFF0DC'
    }
    this.dom.onmouseout = () => {
        if(!this.isOpen)this.dom.style.backgroundColor = '#C9CABB'        
    }
